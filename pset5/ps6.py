...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        allLetters = string.ascii_lowercase + string.ascii_uppercase  # builds the string of letters
        allDict = {}  # store the temp dict
        shiftedDict = {}  # store the shifetd dict
        for number in range(len(allLetters)):
...
class PlaintextMessage(Message):
    ...
    def get_message_text_encrypted(self):
        ...
        for letter in self.message_text_encrypted:
            return str(letter)
        '''
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        #split_messaage_text = self.message_text.split()
        #print(split_messaage_text)
        tempWord = {}
        bestString = ()
        bestNow = 0
        count = 0
        loadedWords = load_words("words.txt")
...
test1 = CiphertextMessage("jgnnq")
print(test1.decrypt_message())
